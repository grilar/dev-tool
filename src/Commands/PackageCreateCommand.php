...
namespace Grilar\DevTool\Commands;

use Grilar\DevTool\Commands\Abstracts\BaseMakeCommand;
...
class PackageCreateCommand extends BaseMakeCommand
{
    public function handle(): int
    {
        ...
        $this->line(
            '<info>Add</info> <comment>"grilar/' . $package . '": "*@dev"</comment> to composer.json then run <comment>composer update</comment> to install this package!'
        );
        $this->line('------------------');
